...
#Version:2.0
#Author: Caprese Smith
#Date: November 11/17/2021
#
...
while ($destination -eq ""){
 ...
 Write-Host
 Write-Host
 $destination = read-host " Enter the name of your favorite travel destination "
}
...
while ($color -eq ""){
 ...
 Write-Host
 Write-Host
 $color = read-host " Enter the name of your favorite color "
}
...
Write-Host " spotting a gigantic $destination moving quickly towards the"
...
Write-Host " almost deserted except for the old $color, where the citizens"
...
Write-Host " and Molly instantly knew what to do, each grabbing a $color" 
...
Write-Host
Write-Host
Write-Host " The townsfolk ran out of the $store and threw a big block party for"
Write-Host " their heroes. Once again The Three Amigos had saved the day. Time to party!"
Write-Host
Write-Host
Write-Host
Write-Host
